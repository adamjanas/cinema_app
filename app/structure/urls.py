from app.structure.views import (AdvertisementCreateView,
                                 AdvertisementDeleteView,
                                 AdvertisementListView,
                                 AdvertisementUpdateView, HallCreateView,
                                 HallDeleteView, HallListView, HallUpdateView,
                                 MovieCreateView, MovieDeleteView,
                                 MovieListView, MovieUpdateView,
                                 PriceCreateView, PriceDeleteView,
                                 PriceListView, PriceUpdateView,
                                 PromotionCreateView, PromotionDeleteView,
                                 PromotionListView, PromotionUpdateView,
                                 SeatCreateView, SeatDeleteView, SeatListView,
                                 SeatUpdateView, ShowCreateView,
                                 ShowDeleteView, ShowListView, ShowUpdateView)
